...
const SearchFlight = ({setShowCreateForm,setShowList}) =>
{
  ...
  function ClickHandler2(){
    ...
    const sub = function (e) {
        e.preventDefault()
        axios.post("http://localhost:8000/search-flight", JSON.stringify({
    ...
    <input type="text" id="FlightNumber" name="FlightNumber" onChange={(event) => setFlightNumber(event.target.value)}/>
    <p>
    <br>
    </br>
    </p>
    <label for="Departure">Departure:</label>
    <input type="text" id="Departure" name="Departure"  onChange={(event) => setDeparture(event.target.value)}/>
    <p>
    <br>
    </br>
    </p>
    <label for="Arrival">Arrival:</label>
    <input type="text" id="Arrival" name="Arrival"  onChange={(event) => setArrival(event.target.value)}/>
    <p>
    <br>
    </br>
    </p>
    ...
    <label for="NumberOfBusinessClassSeats">NumberOfBusinessClassSeats:</label>
    <input type="text" id="NumberOfBusinessClassSeats" name="NumberOfBusinessClassSeats"  onChange={(event) => setNumberOfBusinessClassSeats(event.target.value)}/>
    <p>
    <br>
    </br>
    </p>
    ...
    <button type="Create Flight" value="Create Flight" onClick={sub} >create flight </button>
  </form> )
}
